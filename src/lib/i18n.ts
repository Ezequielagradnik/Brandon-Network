...
export const dict = {
  es: {
    ...
    admin: {
      ...
      usersTitle: "Usuarios",
      cols: { user: "Usuario", email: "Email", role: "Rol", status: "Estado", lastLogin: "Último acceso" },
      active: "Activo",
      inactive: "Inactivo",
      never: "Nunca",
  ...
  en: {
    ...
    admin: {
      ...
      usersTitle: "Users",
      cols: { user: "User", email: "Email", role: "Role", status: "Status", lastLogin: "Last login" },
      active: "Active",
      inactive: "Inactive",
      never: "Never",
  ...
  pt: {
    ...
    admin: {
      ...
      usersTitle: "Usuários",
      cols: { user: "Usuário", email: "Email", role: "Função", status: "Status", lastLogin: "Último acesso" },
      active: "Ativo",
      inactive: "Inativo",
      never: "Nunca",
