...
export const dict = {
  es: {
    ...
    sidebar: { asistente: "Asistente", noticias: "Noticias", irs: "IRS", videos: "Videos", admin: "Admin", logout: "Cerrar sesión", expand: "Expandir", collapse: "Colapsar", newChat: "Nuevo chat", chats: "Tus chats", loadMore: "Cargar más" },
    asistente: {
  ...
  en: {
    ...
    sidebar: { asistente: "Assistant", noticias: "News", irs: "IRS", videos: "Videos", admin: "Admin", logout: "Sign out", expand: "Expand", collapse: "Collapse", newChat: "New chat", chats: "Your chats", loadMore: "Load more" },
    asistente: {
      title: "Your AI",
      accent: "assistant",
  ...
  pt: {
    ...
    sidebar: { asistente: "Assistente", noticias: "Notícias", irs: "IRS", videos: "Vídeos", admin: "Admin", logout: "Sair", expand: "Expandir", collapse: "Recolher", newChat: "Novo chat", chats: "Suas conversas", loadMore: "Carregar mais" },
    asistente: {
