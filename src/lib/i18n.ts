...
export const dict = {
  es: {
    ...
    sidebar: { asistente: "Asistente", noticias: "Noticias", irs: "IRS", videos: "Videos", admin: "Admin", logout: "Cerrar sesión", expand: "Expandir", collapse: "Colapsar" },
    asistente: {
  ...
  en: {
    ...
    sidebar: { asistente: "Assistant", noticias: "News", irs: "IRS", videos: "Videos", admin: "Admin", logout: "Sign out", expand: "Expand", collapse: "Collapse" },
    asistente: {
      title: "Your AI",
      accent: "assistant",
  ...
  pt: {
    ...
    sidebar: { asistente: "Assistente", noticias: "Notícias", irs: "IRS", videos: "Vídeos", admin: "Admin", logout: "Sair", expand: "Expandir", collapse: "Recolher" },
    asistente: {
