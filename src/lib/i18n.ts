...
export const dict = {
  es: {
    ...
    about: {
      ...
      waClient: "¿Me ayudan con el W-8BEN?",
      waBrandon: "Claro, te guío ahora mismo.",
  ...
  en: {
    ...
    about: {
      ...
      waClient: "Can you help me with the W-8BEN?",
      waBrandon: "Of course, I'll walk you through it.",
  ...
  pt: {
    ...
    about: {
      ...
      waClient: "Podem me ajudar com o W-8BEN?",
      waBrandon: "Claro, eu te guio agora.",
